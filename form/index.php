...
<body>
  ...
  if (isset($_GET['track_id'])) {
    ...
    $track_id = (int) filter_var($track_id, FILTER_SANITIZE_NUMBER_INT);
  ...
  <div class="container">
    ...
    <form method="POST" action="index.php">
        ...
        <div class="form-row">
          <div class="col-4">
            ...
            <div class="input-group input-group-sm">
              ...
              <input name="track_id" id="track_id" type="number" class="form-control form-control-sm" placeholder="Nomor Track ID" pattern="[0-9]" min="0" required>
            </div>
      ...
      <div class="form-group">
        <div class="form-row">
          ...
          <div class="col-3 offset-1">
            <label>CREW</label>
            <select class="browser-default custom-select" id="crew" name="crew">
      ...
      <div class="form-group">
        ...
        <div class="form-row">
          <div class="col-3">
            <select class="browser-default custom-select" id="kode" name="kode" required>
